...
expected = {
    ...
    "noSocialDeductionLimit": Decimal("0.00"),
    "protectedCategoryLimit": Decimal("3814650.00"),
    "disabilityOneTwoLimit": Decimal("21625000.00"),
    "protectedDependentLimit": Decimal("3814650.00"),
    "protectedDependentRemainder": Decimal("4650.00"),
...
assert actual["bankRegisterEmployeeIban2026"] == "KZ000000000000000002"
assert actual["currentEmployeeIban2026"] == "KZ000000000000000009"
